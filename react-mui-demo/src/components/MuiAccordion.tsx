      ...
      <Accordion expanded={expanded === 'panel1'} onChange={(event, isExpanded) => handleChange(isExpanded, 'panel1')}>
        ...
        <AccordionDetails>
          <Typography>
            ...
            itaque nulla architecto ipsam commodi odio modi rerum sint tempora
            soluta, voluptas delectus perspiciatis. Iste, quidem explicabo dolor
            quasi repellat asperiores.
          </Typography>
        </AccordionDetails>
      </Accordion>
